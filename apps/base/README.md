...
- Platform and support services: [Authelia](authelia/README.md), [Code Server](code-server/README.md), [External DNS](external-dns/README.md), [Guacamole](guacamole/README.md), [n8n](n8n/README.md), [Shared Storage](shared_storage/README.md), [VolSync](volsync/README.md)
